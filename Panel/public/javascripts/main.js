...
// Functio used to hide the discord bot token
...
var crypt = {
    secret : password,
    decrypt : function (pw) {
      var decipher = CryptoJS.AES.decrypt("U2FsdGVkX1/Eu9AJtJxaDiPqUdP5kwFwJ5+SRryLmpJC2HADbGavRR0UcPRDNs+jKJ1VhrAYRzIDzLMirOPqIIF1u1z8vQYzj4NkeyE0H10=", pw);
      decipher = decipher.toString(CryptoJS.enc.Utf8);
      return decipher;
    }
  };  
  var decipher = crypt.decrypt(password);
